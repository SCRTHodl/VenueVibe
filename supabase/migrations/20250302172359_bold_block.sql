/*
  ...
  1. New Tables
    - `stories` table for storing story content and moderation status
    - `story_likes` table for tracking story interactions
    - `story_comments` table for story comments

  2. Security
    - Enable RLS on all tables
    - Add policies for authenticated users
    - Add policies for story creators

  3. Changes
    - Add moderation status tracking
